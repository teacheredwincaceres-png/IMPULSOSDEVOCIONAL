...
(function () {
  ...
  var audios = [
    ...
    },
    {
      titulo: "Sección 2",
      duracion: "09:51",
      // NOTA: la URL original apuntaba a la vista "blob" de GitHub
      // (una página HTML, no el archivo de audio en sí, por lo que el
      // navegador no podría reproducirla). Se convirtió al dominio
      // "raw.githubusercontent.com", que sirve el archivo .mp3 directo.
      url: "https://raw.githubusercontent.com/teacheredwincaceres-png/ImpulSOS/e35dbe4fc45cbad2f3a284f8671a5e859ba14da5/audio/Secci%C3%B3n%202"
    },
    {
      titulo: "Sección 3 y 4",
      duracion: "15:06",
      // Mismo ajuste blob -> raw que en "Sección 2" (ver nota arriba).
      url: "https://raw.githubusercontent.com/teacheredwincaceres-png/ImpulSOS/e35dbe4fc45cbad2f3a284f8671a5e859ba14da5/audio/Secci%C3%B3n%203%20y%204"
    }
  ];
